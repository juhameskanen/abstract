...
% Commented out to prevent build failure if file is missing:
...
\begin{figure}[h!]
\centering
% Note: Ensure this file exists in papers/paper-name/figures/
...
\begin{itemize}
    ...
    \item \textbf{Gravitational Coupling:} Investigating how bitstring complexity defines local geometry.
\end{itemize}

\section*{Simulation Code}
Python simulation is implemented in \texttt{phi4\_qbitwave\_final.py}.
