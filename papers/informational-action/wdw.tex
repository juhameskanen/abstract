...
\begin{abstract}
  ...
  This framework provides an algorithmic justification for the emergence of classical spacetime and the principle of least action as a consequence of minimal description length.
...
The canonical quantization of general relativity leads to the Wheeler-DeWitt equation \cite{dewitt1967quantum}:
\begin{equation}
...
In this work we propose \textit{Algorithmic Quantum Cosmology} (AQC).
...
According to Solomonoff induction and algorithmic probability, the natural prior weight for any observer is
\begin{equation}
...
Typical observers, selected by algorithmic probability, inhabit smooth classical spacetimes.
...
\begin{acknowledgements}
  We thank the foundational ideas of Don Page, William Wootters, and the developers of algorithmic information theory.
  Numerical explorations were performed using custom Python code with NumPy and SciPy FFT routines.
...
J.~B.~Hartle and S.~W.~Hawking, ``Wave function of the Universe,'' Phys. Rev. D \textbf{28}, 2960 (1983).

\bibitem{page1983clock}
...
W.~K.~Wootters, ````Time'' replaced by quantum correlations,'' Int. J. Theor. Phys. \textbf{23}, 701 (1984).

\bibitem{solomonoff1964formal}
R.~J.~Solomonoff, ``A formal theory of inductive inference,'' Inf. Control \textbf{7}, 1 (1964).
