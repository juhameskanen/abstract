...
\title{\textbf{Supplementary Material: Reading a Timeless Universe}}
...
According to the \textbf{Algorithmic Selection Principle (ASP)}, an observer is exponentially more likely to self-locate along paths of \textbf{Minimal Description Length (MDL)}. The probability of a specific history $H$ is given by the universal distribution:
\begin{equation}
    P(H) \propto 2^{-K(H)}
\end{equation}
