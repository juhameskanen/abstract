...
\begin{abstract}  
  ...
  based on elational ordering of these configurations. We identify an emergent \emph{ordinal time} within the static Wheeler--DeWitt multiverse.
  Observer-experienced reality is then dominated by histories that minimize algorithmic description length providing a unified mechanism for the emergence of time,
  unitarity, quantum probabilities, and the suppression of divergences. Observers most likely find them from maximally compressed permutations,
...
Highly irregular configurations require longer descriptions and are suppressed under ASP, leading to an effective low-frequency, smooth structure.
