...
We can build digital replications of living cells in computers. In the future, we might be able to run more complex simulations of life. These simulated creatures wouldn't truly exist, other than in form of equations executed in our computer.

Do those digital replicas qualify as life too?

Anyway, certain characteristics appear repeatedly across all known living systems.

Due to second law of thermodynamics complex systems tend naturally toward disorder rather than order. By favoring structures
that better preserve and replicate information, evolutionary processes gradually accumulate complexity and functionality. Our DNA appear to play an essential role here. Life is a low entropy system, continuously streaming out disorder and feeding in order.

Life needs well defined informational inside/outside boundaries. Even a tiny amount of intrusion is typically lethal. For example, if a human skin is woonded, the consequences are usually catastrophic.
The atoms themselves remain, but the internal organization gradually breaks down.

The Cell as the universal entity. All living systems on Earth are based on cells. 
