...
Now consider what travel to the past would imply. A macroscopic object appearing from the future would introduce a large amount of mass-energy and information into an otherwise closed system without any causal precursor.
...
The arrow of time, then, is not merely psychological, nor purely statistical. It is a structural consequence of information conservation. The past is fixed because its information has already been distributed.
The future appears open because multiple informational rearrangements remain compatible with the present.
