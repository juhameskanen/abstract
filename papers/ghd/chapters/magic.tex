...
By requiring a breakdown of both observation and logic, we find that the best synonym for a system built on non-logical reasoning is perhaps \emph{nonsense}.
...
Physics, therefore, is where the abstract meets the empirical.  Physics could be defined as the \emph{subset of mathematics that is observationally accessible}.
