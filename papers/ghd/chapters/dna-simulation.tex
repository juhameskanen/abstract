...
Due to the large number of spheres and cores, the simulated human would conclude that the wave function must be complex-valued with phase coherence,
...
The only common factor between different implementations appears to be the logic they are running. 
