...
If we build a digital universe that duplicates the essential properties of our own, then whatever "mystery" we don’t understand must be present within the machine running the code. The problem of the "Infinite Unknown" is suddenly reduced to the "Finite Known."

I may not understand the cosmos, but I understand software completely. By moving the mystery from the vacuum of space into a block of silicon, we turn a metaphysical puzzle into a debuggable program.
