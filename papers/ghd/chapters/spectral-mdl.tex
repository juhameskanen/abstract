...
Two of these configurations can be interpreted as a black hole simulation and its Turing Machine implementation. Equally well they can be viewed as a set of videos, each with a capacity of $n$ bits—a single ``movie.''
...
While the Anthropic Principle---the idea that things appear as they do simply because we wouldn't be here to observe them otherwise---accounts for observer selection, it lacks quantitative predictive power.
Furthermore, the number of such coherent configurations is vanishingly small compared to the total number of possible configurations.
The probability of finding ourselves on such a path by pure chance is practically zero under a uniform measure over all configurations.
