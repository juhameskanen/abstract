...
It was this missing ``pain function'' in the standard library of \texttt{C} that planted the seed of an obsession. That seed has grown, over years of trial and error, into the work that follows.


\section*{Method and Approach}

The conclusions presented here were developed using standard software design methods and tools—the same ones I have relied on throughout my career as a software professional. The software built with these methods works. Correspondingly, I believe, the conclusions
developed with them should hold too. 
...
I extend my heartfelt gratitude to my wife. She is quite a piece of work and incredibly complicated——certainly beyond anything represented in the standard library of \texttt{C}. She patiently endured countless nights beside me as I typed away on my noisy laptop. Despite the many disruptions to her sleep, she remained remarkably understanding and supportive throughout the writing of this book.

I also owe a deep debt of gratitude to my brother—and an apology for the many fishing trips I have likely spoiled by insisting he listen to my theories.
