...
\section*{Can computer or even a thermostat feel pain?}

No. A computer or even a simple thermostat, given sufficient time, could in theory duplicate the informational state of a suffering human.
...
It therefore cannot create new suffering Alice. It discovers (traces out one) of the very many configurations that describe an equivalence class - Alice.
