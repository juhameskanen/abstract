...
However, if the axioms of this framework hold, there is no causal relationship between the silicon hardware and the simulated mind.
...
It therefore cannot create new Alice. It discovers (traces out one) of the very many configurations that are Alice.
