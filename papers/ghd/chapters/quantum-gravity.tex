...
Just as it feels right to assume nothing, it also feels right that there should be only one theory that describes the universe. 

Both GR and QM suffer from arbitrary, hardcoded pre-assumptions, yet both work spectacularly well within their respective domains.
However, the moment we attempt to merge them into a single, unified theory of Quantum Gravity, this brilliant track record comes to a screeching halt.
When we plug the smooth, continuous geometry of spacetime into the violent, probabilistic machinery of quantum mechanics, the equations do not just fail; they fail spectacularly, yielding infinite probabilities and nonsensical results.
