...
While QFT deals with the "values" stored in the memory cells, GR defines the "memory addresses" themselves, the distance between those addresses, and the routing rules for traversing the pointer space.
...
But the true, mind-bending complexity of GR is that \textbf{the database writes back to itself}. 
