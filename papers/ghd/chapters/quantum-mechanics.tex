...
However, the photon is not assigned a single trajectory. Instead, it can be shown that it takes all the possible paths. Contributions from all
...
This was quite math intense chapter. However, quantum mechanics is mathematically simple.

It describes a world where:
\begin{itemize}
\item possibilities are encoded in superpositions
\item outcomes arise through interaction (observation)
