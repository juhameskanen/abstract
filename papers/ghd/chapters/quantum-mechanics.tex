...
To make this intuitive, consider a quantum coin. Unlike a real coin in our geometric space, a quantum coin exists as a superposition of states within a two-dimensional Hilbert space. Unlike a classical coin, which is restricted to two discrete states (Head, Tail), the quantum coin is described by a state vector:
...
(Finally we know the deep secret of consciousness : we are stable records of information!)
...
The world is full of excellent books describing and explaining the fancy and counter intuitive
consequences of Quantum Mechanics. However, we settle to to this super dense list of essential features.

What is it that we are observing?
