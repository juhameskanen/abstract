...
At the heart of quantum mechanics lies the so-called \emph{wavefunction}.  
It is a mysterious entity: it has no mass, no electric charge, and it does not emit or absorb light.  
It cannot be directly measured by any instrument.  
...
the information content would scale exponentially exponentially with system size.
...
\section{Universal Studios of Reality}
