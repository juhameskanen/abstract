...
\begin{figure}[h!]
\centering
\includegraphics[width=1.0\textwidth]{figures/twoslitexperiment.jpg}
\caption{Observable result of the unobservable wavefunction}
\end{figure}


In modern formulations, what we call ``particles'' are excitations of underlying fields. Some of these, such as photons, can be directly detected. Others reveal themselves only indirectly through their effects.
...
.
It is as if the universe is being governed by a set of invisible rules written in a language we invented, and somehow, the universe insists on following them.
...
Any attempt to construct a foundational theory of reality must, either explicitly or implicitly, address three independent questions:

\begin{enumerate}
    \item \textbf{Ontology:} What exists?
    \item \textbf{Measure:} What is typical or probable?
    \item \textbf{Emergence:} How does structure arise?
\end{enumerate}
...
%    \item \textbf{Unstructured / noise:} No preferred representation or structure (hypothetical minimal ontology)
\end{itemize}

\subsection{Measure (What is Typical)}
...
%    \item \textbf{Emergent measure:} Measure derived from structural properties (e.g., compressibility-based approaches)
\end{itemize}

\subsection{Emergence (How Structure Arises)}
