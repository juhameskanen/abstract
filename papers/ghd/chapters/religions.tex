...
While every account is unique, researchers such as Pim van Lommel have identified several core elements common to these episodes:
...
Pim van Lommel, a Dutch cardiologist, published a landmark study in \emph{The Lancet} (2001).
...
He found that some patients reported clear, structured consciousness at a time when their brains showed no measurable electrical activity (clinical death). 
...
Unlike typical hallucinations, NDEs almost always result in a permanent personality shift and the removal of the fear of death. 

However, empirical verification remains elusive.
If a consciousness can truly float above the physical body, could it observe objects on high shelves or in adjacent rooms that are hidden from the patient's physical line of sight? To date, no single controlled experiment has produced a verifiable instance of such "hidden" observation.

Science acknowledges that consciousness is far more resilient than once thought; the "lights" do not go out instantly.
We now know the house remains ``powered'' for some time after the main generator fails.

Whether that power stems from a backup battery (the residual brain state) or an entirely different power grid (the soul) remains the ultimate mystery.
