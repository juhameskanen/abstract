...
Because geometry provides a compact representation of gravitational dynamics.

Instead of explicitly tracking:
\begin{itemize}
\item Every particle trajectory
\item Every gravitational interaction
\item Every force exchange
\end{itemize}

General Relativity encodes gravitational influence into a single tensor field:
...
Just as a quantum state in Hilbert space compactly encodes a vast superposition of
classical alternatives, spacetime geometry encodes the gravitational influence of matter into a smooth tensor field.
