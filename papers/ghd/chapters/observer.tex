...
However, again, physics (and maybe even common sense) push back.
...
Life itself proves difficult to define.
...
We can build digital replications of living cells in computers. Do those digital replicas qualify as life too?

In the future, we might be able to run more complex simulations of life. These simulated creatures wouldn't truly exist, other than in form of
equations executed in our computer. 

Certain characteristics appear repeatedly across all known living systems.
