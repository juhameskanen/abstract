...
Life appears to be difficult to classify.
...
can exist in spiritual form—such as souls.
However, here it is not only the physics that fight back but also logical reasoning.


\section{Conclusions}

Definitions of life partially boil down to the hard problem of consciousness. We do not have a definition of consciousness, which is an essential
property of living humans.

All we can say is that certain characteristics appear repeatedly across all known living systems.
