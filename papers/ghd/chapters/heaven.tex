\chapter{Virtual Universes}

\section{Common Sense Revisited}

Many find it difficult to believe in God, Heaven, or Hell because the concepts seem to defy common sense. How could a rational mind be expected to believe in something as "absurd" as realms that can neither be seen nor touched? How could such invisible, unobservable places possibly exist?

Now, these ideas no longer feel quite so ridiculous. The fact that a human being is an implementation of an axiomatic system—and as such, can be simulated to create virtual counterparts—may, surprisingly, save the concept of God.
...
Controversially, Heaven and Hell can exist precisely because the Church-Turing thesis holds, the four initial axioms hold, and we reject all unexplained metaphysical or supernatural agents in favor of a computational reality.
