...
Suppose we possessed a complete physical description of the universe: every particle state,
every quantum amplitude, every bit of information.
...
The same finite configuration may be interpreted as a number, a computation,
a universe, random noise, or nothing at all.
