...
\begin{figure}[htbp]
    ...
    % Level 0 - Raw U
    \node[base] (U) {Static Informational Totality \\ \textbf{U} \\ \small (Naked Bits / Raw Configurations)};
    
    % Level 1 - Interpretation
    \node[observer, below=of U] (Interp) {Interpretations / Mappings};
    \node[observer, right=of Interp] (Obs) {Observers / Interpreters \\ \small (Compressed relational wavefunctions $\psi_o(\lambda)$)};
