...
Consider a massive spherical dust cloud. Each dust particle can be mapped to a sequence of memory bits. 
Together, the particles form a long continuous bitstring representing a temporal slice of the simulation.

Initially, the bitstring is random:

\begin{verbatim}
00000100101011110101010101001010100101010101010101001001001110101010010100101010...
...
\end{verbatim}
...
As the simulation evolves, the cloud collapses under its own gravity. Measuring the entropy of the bitstring over time shows a monotonic decrease. 
Numerical instabilities prevent the simulation from reaching the final singularity, but extrapolation of the execution trace suggests:

\begin{verbatim}
...
00001000010000010010001000000001000100000000000001000010000000010000000100010000...
00001001000000000010000000000000010000010000000001000000000000000000100000000001...
00000001000000000000000000000001000000000000000000000100001000000000000000000100...
[crash]
\end{verbatim}
...
In classical GR, curvature diverges as geodesics converge, but this may reflect the limits of the geometric description rather than a physical pathology—analogous to measuring surface derivatives at the north pole of a sphere.

Remarkably, the zero-entropy conclusion is invariant under coordinate choice, representation, or dimensionality. 
Mapping information to geometry inevitably yields the same minimal object: a point. 
