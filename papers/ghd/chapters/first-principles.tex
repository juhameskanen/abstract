...
There exist theories that attempt to derive physics from minimal assumptions!
...
However, none of these theories are truly presumptionless, they assume quite a lot. Tegmark assumes that mathematical structures exist as fundamental substrate. It from Bit implicitely assumes Quantum Mechanics. Both are quite a lot to be assumed!
