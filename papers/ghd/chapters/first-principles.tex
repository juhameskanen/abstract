...
There exist theories that attempt to derive physics from minimal assumptions. Ludwig Boltzmann proposed that in a system at thermal equilibrium (maximum entropy), rare fluctuations can temporarily produce ordered structures. In such a framework, sufficiently complex configurations—including observers—can arise given enough time. 
