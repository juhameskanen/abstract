...
However, none of these theories are truly presumptionless. Tegmark assumes that mathematical structures exist as a fundamental substrate, and 'It from Bit' takes the validity of quantum mechanics for granted. In both cases, the 'minimal' starting point is actually quite a lot to assume.
