...
The "Problem of Time" in physics is easily understood through the lens of state management. In a running program, time is the sequence of state mutations.
But we have landed in static fully self contained universe which just is. Every possible state of every possible system is already "compiled" into a single, massive, static lookup table.
