...
\section{Quantum Gravity Candidates}
...
A truly complete theory of everything should describe all phenomena. Even better, it would explain not only how entities behave but also why they exist and what they are at their core.
...
If a Theory of Everything aspires to completeness, it should explain everything—including the existence, structure, and role of observers. A framework that leaves the observer conceptually outside its scope cannot claim to be fully self-contained.
