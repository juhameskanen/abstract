...
where $\mathcal{A}$ denotes the set of fundamental assumptions left unexplained, such
as the dimensionality and topology of spacetime, the existence and nature of fields, the values of physical constants, the choice of symmetry groups,
and the ontological status of the mathematical entities employed by the theory.

A truly complete theory would not merely describe how given entities behave; it would also account for why those entities, structures, and constants exist in the first place.
