...
\begin{equation}
C_G[h] \approx \alpha \int (\partial_\lambda h_{\mu\nu}) (\partial^\lambda h^{\mu\nu}) \, d^4x,
\end{equation}

neglecting higher-order terms $\mathcal{O}(h^3)$.  

- This can be interpreted as smoothness penalty in the simulation.  
- The Laplacian $\Box h_{\mu\nu}$ arises naturally from the quadratic form.  
- In this limit, variations of $C_G$ with respect to $h_{\mu\nu}$ yield **linear field equations**:

\begin{equation}
\Box h_{\mu\nu} = \frac{\beta}{\alpha} T_{\mu\nu},
\end{equation}
...
- This can be take as the **worldline cost functional** in the weak-field.
