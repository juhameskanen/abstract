\chapter{Typical Database Software}
...
Despite centuries of inquiry, no consensus exists regarding the physical or metaphysical source of consciousness. On the contrary, the scientific and philosophical literature presents an unusually broad and fragmented landscape of proposals. Nearly every level of physical description—from the largest cosmological structures to the smallest quantum entities—has, at some point, been suggested as the seat or origin of conscious experience. The diversity of these proposals is itself a noteworthy empirical fact.
...
Taken together, these proposals reveal a striking pattern: there is no privileged scale, structure, or object that has not been nominated as the source of consciousness by someone. The explanatory burden has been shifted repeatedly—from minds to brains, from brains to cells, from cells to molecules, from molecules to quantum states, and from quantum states to spacetime or cosmology—without converging on a definitive answer.

This dispersion suggests that the difficulty may not lie in identifying the correct physical component, but in the framing of the question itself. If consciousness can plausibly be attributed to almost any level of description, then perhaps it is not a localized property of particular objects at all, but a relational or structural feature arising from how information is organized, processed, and experienced.

Anyway, if Penrose~\cite{penrose1994shadows} is right and consciousness is not an axiomatic system, 
then what else is there? Can physics ever answer these deep questions, or must we look beyond science for answers? 
