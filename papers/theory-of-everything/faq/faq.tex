...
However, the theory places a fundamental constraint on unbounded recursive simulation: \textbf{entropy}. It is informationally expensive to \emph{realize} one. Extracting, encoding, and maintaining the information required to faithfully describe even a single human genome is already nontrivial. Scaling this to billions of humans, each composed of billions of cells, embedded in a universe containing astronomical numbers of particles and interactions, rapidly exhausts available informational resources.
