...
\begin{figure}[h!]
\centering
\includegraphics[width=1.0\textwidth]{figures/compression_max_probability.png}
...
\begin{figure}[h!]
\centering
\includegraphics[width=1.0\textwidth]{figures/msl.png}
...
\begin{itemize}
\item \href{simulation/observer\_probability.py}{observer\_probability.py: Python program serving as proof-of-concept}
\end{itemize}
