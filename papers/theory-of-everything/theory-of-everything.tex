...
The three entities are orthogonal functional roles, not alternative encodings of the same role.
...
\item The geometric ensures separation, persistence, and identity.
\end{enumerate}
  
Geometry is the only known mechanism for implementing an inside–outside invariant.
...
Observer is a sub-set of $\mathcal{C}$.
