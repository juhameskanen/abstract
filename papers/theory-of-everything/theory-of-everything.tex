...
\title{Informational, Abstract Model of Everything ($IaM^e$}
\date{2025}
...
Building on the conclusions derived in Paper 1 - 3, we propose new approach to unify GR and QM in which the nature of everything is fundamentally undefined and random.
...
\subsection*{Axiom 1: Wavefunction as Compression Residual}
...
according to the determistic wave function. Interference and other quantum mechanical features are
...
Geometry is the most native framework for such a description.
