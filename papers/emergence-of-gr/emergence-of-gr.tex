...
\begin{figure}[h]
    ...
    \caption{Minimal MDL path without memory}
    \label{fig:geodesic-from-mdl}
\end{figure}

\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/geodesic_from_mdl_memory.png}
    \caption{Minimal MDL path with memory }
...
\begin{itemize}
    ...
    \item \href{simulations/geodesic_from_mdl_memory.py}{geodesic\_from\_mdl\_memory.py} 
