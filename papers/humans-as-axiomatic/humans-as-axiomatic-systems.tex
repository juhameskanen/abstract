...
of an underlying informational structure. We introduce the notion of \emph{execution-trace entropy}, 
...
\begin{itemize}
    \item \texttt{schwarzschild.py} — Schwarzschild black hole simulation
    \item \texttt{kerr.py} — Kerr black hole simulation
    \item \texttt{blackhole.py} — common base classes
\end{itemize}
