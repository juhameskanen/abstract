...
\begin{abstract}
We show that, under four minimal physical axioms, human observers must be formal axiomatic systems whose state transitions are fully determined by physical law and informational structure. From this, we demonstrate that any simulation preserving the internal causal topology and behavioral trace of such a system must instantiate causally efficacious subjective experience in order to remain behaviorally equivalent. We further prove that temporal experience is not a fundamental property of the universe but an emergent, internal property of the observer’s relational structure. These results jointly establish a strict ontological equivalence between physical and informational realizations of observers: substrate, execution order, and external runtime have no privileged status. Consequently, any logically consistent arrangement of a finite information set is ontologically equivalent, though only a vanishingly small subset of configurations encode observers with coherent subjective experience. Reality is therefore fundamentally abstract and substrate-independent, emerging from an ensemble of informational configurations rather than from a distinguished physical instantiation. The framework is explicitly falsifiable.
\end{abstract}
...
Any configuration with the capacity to encode a self-referential algorithm instantiates experience. Consciousness is the inevitable internal property of structured information, independent of substrate or external "runtime." The universe is fundamentally an algorithmic ensemble, and the transition from "Abstract" to "Real" is simply a measure of internal redundancy.
