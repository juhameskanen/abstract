...
\begin{abstract}
  We show that human observers are formal axiomatic systems whose properties can be fully mapped to informational structures. From this, we demonstrate that any simulation preserving the internal causal logic of such a system must instantiate subjective experience; to do otherwise would break the behavioral equivalence of the system. We further prove that temporal experience is not a fundamental property of the universe but an emergent, internal property of the observer’s relational structure. These results establish a strict \textbf{ontological equivalence}: the physical brain and the informational simulation are merely different arrangements of the same finite information set. Reality is therefore fundamentally abstract and substrate-independent, emerging from an ensemble of informational configurations rather than from a distinguished physical substrate. The framework is explicitly falsifiable.
\end{abstract}

  
\ifdefined\ishtml
\begin{center}
\small \href{index.pdf}{Download PDF Version}
\end{center}
\fi
