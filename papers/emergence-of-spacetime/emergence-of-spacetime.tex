...
% --- Document Metadata ---
\title{\textbf{Increasing Entropy and Emergence of Spacetime}}
...
\begin{abstract}
  Building on the ontological equivalence of informational and physical configurations (Paper~I) and the identification of black hole singularities as zero-entropy fixed points (Paper~II),
  we investigate the emergence and expansion of spacetime as a consequence of increasing entropy.
  Using a minimal computational model, we evolve a zero-entropy bitstring through random mutations, interpreting its states as geometric structures in three-dimensional space.
  ...
  Our results suggest that cosmic expansion can be understood as a geometric manifestation of increasing informational entropy, with complexity and structure arising naturally from simple, initially smooth states.
  This framework reinforces the informational perspective on spacetime and provides a formal, falsifiable link between entropy growth and the emergence of matter and geometry.
\end{abstract}


\ifdefined\ishtml
\begin{center}
\small \href{emergence-of-spacetime.pdf}{Download PDF Version}
\end{center}
\fi
...
The model preserves two key features characteristic of the real universe: (i) the hierarchical structuring of particles, and (ii) the fact that particle sizes do not stretch with the universe, only their mutual distances.
...
\section{Conclusions}
These models are minimal and arbitrary, and as such incapable to serve as any faithful models of the real universe. However, they do reveal a few interesting features.
...
Beginning from a perfectly smooth, zero-entropy configuration, the universe develops complexity through the unfolding of bitstring information under selection filters. This mechanism naturally produces particle-like microstructures, whose statistical properties follow lognormal distributions. A central implication of this is that the singularity at zero entropy is neither undefined nor pathological. At this boundary condition, there is no information and no emergent particles, nor can falling particles ever reach the singularity---the probability a particle finding themselves from the singularity is zero.
...
\section{Future work}
Although this study presents only a minimal toy model of our universe, it demonstrates how a universe like ours could arise. At the same time, it leaves several important open questions:
\begin{enumerate}
    \item How can the structures that emerge from random bit flips attract each other (gravity), and ``wave'' according to quantum mechanical wave function?
    \item If a singularity corresponds to a state of vanishing entropy --- and is therefore incapable of supporting well-defined particles, with spacetime being smooth rather than singular as usually assumed --- then perhaps high-energy effects, such as those attributed to virtual particles in semi-classical gravity, could also be interpreted in this way.
\end{enumerate}

\section{Simulation Software}
The underlying logic for this model is implemented in \texttt{emergence\_of\_spacetime.py}.
