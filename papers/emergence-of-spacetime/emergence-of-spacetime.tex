...
In this sense, the vanishing-entropy limit implies a form of geometric smoothness that is independent of any particular coordinate system or dynamical description. With no information available to define distinguishable microstructures, the singular state cannot encode physical irregularities, even if classical general relativity breaks down. This aligns naturally with the Hartle–Hawking no-boundary proposal, in which the initial singularity is replaced by a smooth, featureless Euclidean geometry.
