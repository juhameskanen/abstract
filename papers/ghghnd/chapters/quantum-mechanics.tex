...
\midrule
Waves & Continuous energy choices & Discrete, quantized energy levels \\
Measurement & Passive sampling of a field & Wave function collapse / Intrinsic randomness \\
Reality & The wave \textit{is} the physical substance & The wave is an abstract probability map for a particle \\
\bottomrule
\end{tabular}
\end{center}
...
The foundational relation of classical kinetic energy, $E_{\text{kinetic}} = \frac{1}{2}mv^2$, is deeply baked into the wave equation.
