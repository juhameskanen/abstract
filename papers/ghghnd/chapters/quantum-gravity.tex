...
\label{chap:quantym-gravity-candidates}
...
First, most formulations are not manifestly background independent. It is a candidate of ToE, except the spacetime geomeotry, which
it doesn't explain but pre-assumes. If a theory starts with a stage already built, someone is entitled to ask who hired the carpenter.
