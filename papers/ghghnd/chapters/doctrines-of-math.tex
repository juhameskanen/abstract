...
Its universality, internal coherence, and predictive power impress themselves upon any careful observer.

Yet Mathematical Pluralism introduces a genuine tension.
If multiple coherent mathematical worlds are possible, why does physical reality correspond so precisely with the particular structures we employ? The software developer's pragmatic attitude---choosing the right tool for the job---is valuable, but it does not fully explain why classical mathematics continues to reveal new planets, particles, and cosmic phenomena before instruments confirm them.
