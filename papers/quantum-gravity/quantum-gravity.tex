...
\ifdefined\ishtml
\begin{center}
\small \href{quantum-gravity-quantum-gravity.pdf}{Download PDF Version}
\end{center}
\fi
...
\begin{figure}[h]
    ...
    \caption{Simulation of unified emergent gravity and Quantum Mechanics}
\end{figure}
\else
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/quantum_gravity.png}
    \caption{Snapshot of a simulation demonstrating unified emergent gravity and Quantum Mechanics}
\end{figure}
\fi

\section{Conclusion}

This work supports the \textbf{Compression–Existence Principle}: the more compressible an observer, the more ways information can be arranged to describe them, and the higher their probability of existence. What we call the “laws of physics” are emergent regularities; they are selected because only such highly compressed observers dominate the measure of existence.
