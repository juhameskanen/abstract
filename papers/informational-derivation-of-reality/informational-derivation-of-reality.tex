...
Static data $R_A$ does not encode an intrinsic temporal ordering; therefore, one cannot argue that one gives rise to the other. 
...
\subsection*{Numerical Precision and Consciousness}
