...
We may gradually optimize the code by introducing lookup tables, eventually replacing all computation with a static, precomputed dataset, denoted by $T_{\text{data}}$.
