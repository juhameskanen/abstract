...
\newcommand{\PrintGlossary}{
    ...
    \item[solipsism] The philosophical position that only one's own mind is certain to exist. 
    

    \item[Liouville's Theorem] Liouville’s equation describes how a probability density evolves in phase space under Hamiltonian dynamics. The flow is incompressible, meaning that the phase-space density remains constant along trajectories. While Newton’s laws track a single trajectory, Liouville’s equation governs the deterministic evolution of an entire distribution. This makes it foundational to statistical mechanics and a classical analogue of quantum evolution. At the fine-grained level, information is not lost: the distribution is continuously stretched and folded through phase space, preserving its local density even as it becomes increasingly intricate.
