...
\begin{abstract}
  Building on the ontological equivalence of physical and informational configurations established in Paper~I,
  ...
  should be understood as well-defined, smooth informational fixed points corresponding to zero-information states.
