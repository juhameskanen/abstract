...
Third, a fundamental theory must explain how complex structures arise from simple underlying rules.
...
\subsection*{4. Name (Observer-dependent nomenclature)}

Finally, a theory requires a name.

This is not a fundamental property of reality,
but an emergent necessity of finite observers attempting to communicate abstract frameworks to one another.

Unfortunately, the space of concise, memorable names appears to be heavily measure-dominated by prior usage.

Most good names are already taken.
