...
The early universe is widely recognized to have inhabited a state of extraordinarily low thermodynamic entropy—a pristine condition that establishes the cosmological arrow of time and drives the evolution of macroscopic systems. Standard physics emphasizes that this initial order is essential for the subsequent emergence of structure, yet it treats this low-entropy boundary condition as an unexplained, fine-tuned miracle. 
...
We may owe our very existence as reasoning agents to this entropic increase. In semi-hostile environments where structures naturally decay, intelligence functions as a highly specialized local filter designed to "fight back" by actively generating local order. 
