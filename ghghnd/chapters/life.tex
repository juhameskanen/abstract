\chapter{What is the minimum requirement for a stable observer?}
\label{chap:evoluton-of-life}
...
There is a science fiction book, \emph{The Black Cloud},
...
\item Informational Boundaries: Life requires well-defined boundaries between the "inside" and the "outside." All life on Earth is founded upon self contained entities, from cellular structures to entire human.
...
Without eliminating anything out, what would then be one most fundamental
attribute of an observer to start with?

\begin{principle}{Observer Requires Informational Boundaries}
{observer-boundaries}

An observer requires well defined boundaries.

\end{principle}

This is the very mechanism that defines the observer into existence, drawing a sharp line between the system doing the measuring and the system being measured.
