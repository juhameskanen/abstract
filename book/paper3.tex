...
In the previous chapter we applied the representational equivalence to
gravitational collapse and found that the geometric description does not
explode to infinity at the singularity. The execution trace converges,
smoothly and provably, to a zero-entropy state --- a structureless
bitstring that decodes to a single unextended point. The singularity is
not where physics breaks down. It is where physics becomes trivially
simple.
