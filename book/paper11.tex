...
Ten chapters in, a careful reader should be asking an uncomfortable
question. We have derived gravity, quantum mechanics, the particle
spectrum, and the expansion of the universe from a single operation
applied to density matrices. The results are clean, the formulas
elegant, the connections between layers surprising in their precision.
This is exactly when a scientist should worry.
